...
//        map.put("Yogurt Smoothie", new MenuInfo("Yogurt Smoothie", 4900, "non-coffee", "요거트 스무디"));
//        map.put("Vanilla Latte", new MenuInfo("Vanilla Latte", 4600, "coffee", "달콤한 바닐라 라떼"));
//        map.put("Strawberry Latte", new MenuInfo("Strawberry Latte", 5800, "coffee", "딸기라떼"));
//        map.put("Kiwi Juice", new MenuInfo("Kiwi Juice", 5500, "non-coffee", "상큼한 키위주스"));
//        map.put("Orange Juice",  new MenuInfo("Orange Juice", 5500, "non-coffee", "달콤한 오렌지주스"));
//        map.put("Apple Juice", new MenuInfo("Apple Juice", 5500, "non-coffee", "달달한 사과주스"));
//
//
//    }
//
...
//                    for(String e : map.) { // 키 값을 기준으로 향상된 for 문을 반복 수행
//                        System.out.println("메뉴 : " + e.name); // 키로 해당하는 값을 얻어냄
//                        System.out.println("가격 : " + e.price);
//                        System.out.println("분류 : " + e.group);
//                        System.out.println("설명 : " + e.desc);
//                        System.out.println("===============================");
//                    }
//                    break;
//                case 2:
