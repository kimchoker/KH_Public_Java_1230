...
// 세마포어 : 여러개의 프로세스가 공통의 메모리(Critical section)에 접근하는 것을 방지하는 것
// 뮤텍스 : 여러개의 스레드가 공통의 메모리 영역에 접근하는 것을 방지하는 것.(자바에서는 synchronized)
public class WorkObject {
    // methodA()는 동기화 처리가 되어서 동시접근 허용을 하지 않는다.
